...
#include "builder/deg_builder_map.h"
#include "builder/deg_builder_rna.h"
#include "depsgraph.h"
...
class DepsgraphRelationBuilder : public DepsgraphBuilder {
 public:
  ...
  virtual void build_idproperties(ID *id_property);
...
#include "builder/deg_builder_relations_impl.h"
