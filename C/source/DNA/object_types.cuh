...
typedef struct Object {
  ...
  //struct Ipo *ipo;
  ///* struct Path *path; */
  //struct bAction *action; /* XXX deprecated... old animation system */
  ...
  /** Grease Pencil data. */
  //struct bGPdata *gpd; /* XXX deprecated... replaced by gpencil object, keep for readfile */
  ...
  //ListBase constraintChannels; /* XXX deprecated... old animation system */
  ...
  /** Окончательная матрица мирового пространства с примененными ограничениями и анимациями. */
  float obmat[4][4];
  ...
  /** Rotation mode - uses defines set out in  for PoseChannel rotations.... */
  //short rotmode;
  ...
  //ListBase nlastrips; /* XXX deprecated... old animation system */
  //ListBase hooks;     /* XXX deprecated... old animation system */
  /** Particle systems. */
  ...
  //struct FluidsimSettings *fluidsimSettings ; /* XXX deprecated... replaced by mantaflow, keep for readfile */
