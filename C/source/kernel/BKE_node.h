...
typedef GHashIterator bNodeInstanceHashIterator;
 ...
 bNodeInstanceHashIterator *BKE_node_instance_hash_iterator_new(bNodeInstanceHash *hash)
{
  return BLI_ghashIterator_new(hash->ghash);
}
 void BKE_node_instance_hash_iterator_init(bNodeInstanceHashIterator *iter,
                                                     bNodeInstanceHash *hash)
{
  BLI_ghashIterator_init(iter, hash->ghash);
}
 void BKE_node_instance_hash_iterator_free(bNodeInstanceHashIterator *iter)
{
...
BKE_node_instance_hash_iterator_get_key(bNodeInstanceHashIterator *iter)
{
 ...
 void *BKE_node_instance_hash_iterator_get_value(bNodeInstanceHashIterator *iter)
{
  return BLI_ghashIterator_getValue(iter);
}
 void BKE_node_instance_hash_iterator_step(bNodeInstanceHashIterator *iter)
{
  BLI_ghashIterator_step(iter);
}
 bool BKE_node_instance_hash_iterator_done(bNodeInstanceHashIterator *iter)
{
