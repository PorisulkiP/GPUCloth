...
extern uint PSYS_FRAND_SEED_OFFSET[PSYS_FRAND_COUNT];
extern uint PSYS_FRAND_SEED_MULTIPLIER[PSYS_FRAND_COUNT];
...
void psys_tasks_create(struct ParticleThreadContext *ctx, int startpart, int endpart,
                       struct ParticleTask **r_tasks, int *r_numtasks);
...
void BKE_psys_collision_neartest_cb(void *userdata, int index,
