...
{
  RecalcInnerNormalsData *data = (RecalcInnerNormalsData*)userdata_v;
  RecalcInnerNormalsTLSData *tls = (RecalcInnerNormalsTLSData*)tls_v->userdata_chunk;
...
static void subdiv_ccg_recalc_modified_inner_normal_task(void *__restrict userdata_v,
                                                         ...
                                                         const TaskParallelTLS *__restrict tls_v)
{
  RecalcModifiedInnerNormalsData *data = (RecalcModifiedInnerNormalsData*)userdata_v;
  SubdivCCG *subdiv_ccg = data->subdiv_ccg;
  CCGKey *key = data->key;
  RecalcInnerNormalsTLSData *tls = (RecalcInnerNormalsTLSData*)tls_v->userdata_chunk;
...
//    for (int i = 1; i < grid_size2 - 1; i++) {
//      CCGElem *grid_element = subdiv_ccg_coord_to_elem(key, subdiv_ccg, &adjacent_edge->boundary_coords[face_index][i]);
...
//}
//
//void subdiv_ccg_neighbors_init(SubdivCCGNeighbors *neighbors,
...
//bool is_corner_grid_coord(const SubdivCCG *subdiv_ccg, const SubdivCCGCoord *coord)
//{
...
//bool is_boundary_grid_coord(const SubdivCCG *subdiv_ccg, const SubdivCCGCoord *coord)
//{
//  const int grid_size_1 = subdiv_ccg->grid_size - 1;
...
//bool is_inner_edge_grid_coordinate(const SubdivCCG *subdiv_ccg,
//                                              const SubdivCCGCoord *coord)
//{
//  const int grid_size_1 = subdiv_ccg->grid_size - 1;
//  if (coord->x == 0) {
...
//}
//
//SubdivCCGCoord coord_at_prev_row(const SubdivCCG *UNUSED(subdiv_ccg),
//                                            const SubdivCCGCoord *coord)
//{
...
//  return result;
//}
//SubdivCCGCoord coord_at_next_row(const SubdivCCG *subdiv_ccg,
//                                            const SubdivCCGCoord *coord)
//{
...
//}
//
//SubdivCCGCoord coord_at_prev_col(const SubdivCCG *UNUSED(subdiv_ccg),
//                                            const SubdivCCGCoord *coord)
//{
...
//  return result;
//}
//SubdivCCGCoord coord_at_next_col(const SubdivCCG *subdiv_ccg,
//                                            const SubdivCCGCoord *coord)
//{
//  UNUSED_VARS_NDEBUG(subdiv_ccg);
...
//}
//int prev_grid_index_from_coord(const SubdivCCG *subdiv_ccg, const SubdivCCGCoord *coord)
//{
//  SubdivCCGFace *face = subdiv_ccg->grid_faces[coord->grid_index];
//  const int face_grid_index = coord->grid_index;
