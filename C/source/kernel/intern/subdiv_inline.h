...
void BKE_subdiv_ptex_face_uv_to_grid_uv(const float ptex_u,
                                                   const float ptex_v,
                                                   float *r_grid_u,
                                                   float *r_grid_v)
{
...
void BKE_subdiv_grid_uv_to_ptex_face_uv(const float grid_u,
                                                   const float grid_v,
                                                   float *r_ptex_u,
                                                   float *r_ptex_v)
{
...
int BKE_subdiv_grid_size_from_level(const int level)
{
  return (1 << (level - 1)) + 1;
}

int BKE_subdiv_rotate_quad_to_corner(const float quad_u,
                                                const float quad_v,
                                                float *r_corner_u,
                                                float *r_corner_v)
{
...
void BKE_subdiv_rotate_grid_to_quad(
...
float BKE_subdiv_edge_crease_to_sharpness_f(float edge_crease)
{
  return edge_crease * edge_crease * 10.0f;
}

float BKE_subdiv_edge_crease_to_sharpness_char(char edge_crease)
{
