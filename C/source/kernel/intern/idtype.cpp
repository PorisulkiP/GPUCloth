...
bool BKE_idtype_cache_key_cmp(const void *key_a_v, const void *key_b_v)
{
  ...
  return (key_a->id_session_uuid != key_b->id_session_uuid) || (key_a->offset_in_ID != key_b->offset_in_ID) || (key_a->cache_v != key_b->cache_v);
}
...
#define INIT_TYPE(_id_code) { \
    ...
    id_types[INDEX_##_id_code] = &IDType_##_id_code; } (void)0
