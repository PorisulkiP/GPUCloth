...
static int ffmpeg_proprty_valid(AVCodecContext *c, const char *prop_name, ID *curr)
{
  int valid = 1;
...
{
  struct ID *prop = (struct ID *)prop_;
  ID *group;
...
static ID *BKE_ffmpeg_property_add(RenderData *rd,
                                           const char *type,
                                           const AVOption *o,
