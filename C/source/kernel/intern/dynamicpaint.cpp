...
/* dissolve inline function */
 void value_dissolve(float *r_value,
                               const float time,
                               const float scale,
                               const bool is_log)
{
                                                   ...
                                                   Scene *scene)
{
  ...
  surface->effector_weights = effector_add_weights(NULL);
                                            ...
                                            const TaskParallelTLS *__restrict UNUSED(tls))
{
  ...
  if (effectors) {
    ...
    effectors_apply(effectors, NULL, surface->effector_weights, &epoint, forc, NULL, NULL);
  }
