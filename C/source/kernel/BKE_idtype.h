...
typedef struct IDTypeInfo {
  ...
  /**
   * Unique identifier of this type, either as a short or an array of two chars, see ID.h's
   * ID_XX enums.
   */
  short id_code;
  /**
   * Bitflag matching id_code, used for filtering (e.g. in file browser), see ID.h's
   * FILTER_ID_XX enums.
   */
  uint64_t id_filter;
   ...
   * Very important, this has to be unique and below INDEX_ID_MAX, see ID.h.
   */
