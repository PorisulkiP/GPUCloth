...
#include "pointcache_types.h" /* for #BPHYS_TOT_DATA */
...
typedef struct PTCacheID {
  ...
  /* flags defined in object_force_types.cuh */
  uint data_types, info_types;
...
void BKE_ptcache_id_clear(PTCacheID *id, int mode, uint cfra);
...
//int BKE_ptcache_mem_index_find(struct PTCacheMem *pm, uint index);
//
