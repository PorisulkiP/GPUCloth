...
GPUCLOTH_FEATURE_EXTENSION = 1 << 2
...
GPUCLOTH_CONSTRAINT_NETWORK_SEAM_STIFFNESS_DEFAULT = 1.0
GPUCLOTH_CONSTRAINT_NETWORK_SEAM_STIFFNESS_MIN = 0.25
GPUCLOTH_CONSTRAINT_NETWORK_SEAM_STIFFNESS_MAX = 5.0


def constraint_network_stiffness_policy(solver_mask):
    """Return the native CN seam-stiffness policy for a solver mask."""
    solver_mask = int(getattr(solver_mask, "value", solver_mask))
    if solver_mask == GPUCLOTH_SOLVER_PD:
        return GPUCLOTH_CONSTRAINT_NETWORK_STIFFNESS_FIXED_DEFAULT
    if solver_mask == GPUCLOTH_SOLVER_MIL2:
        return GPUCLOTH_CONSTRAINT_NETWORK_STIFFNESS_POSITIVE_RANGE
    return GPUCLOTH_CONSTRAINT_NETWORK_STIFFNESS_UNSUPPORTED
...
GPUCLOTH_FEATURE_SEWING = 12
GPUCLOTH_FEATURE_SHRINK = 13
GPUCLOTH_FEATURE_DYNAMIC_MESH = 14
GPUCLOTH_FEATURE_REST_SHAPE_KEY = 15
...
GPUCLOTH_FEATURE_GRAVITY_VECTOR = 49
GPUCLOTH_FEATURE_SIMULATION_QUALITY = 50
GPUCLOTH_FEATURE_AIR_DAMPING = 51
GPUCLOTH_FEATURE_COLLIDER_SURFACE_CONTROLS = 52
GPUCLOTH_FEATURE_MODIFIER_EVALUATION = 53
GPUCLOTH_FEATURE_CACHE_DISK = 35
GPUCLOTH_FEATURE_CACHE_MEMORY = 36
GPUCLOTH_FEATURE_CACHE_EXTERNAL = 37
GPUCLOTH_FEATURE_CACHE_MULTIPLE = 38
...
GPUCLOTH_FEATURE_READBACK = 43
GPUCLOTH_FEATURE_BACKEND_PD = 44
GPUCLOTH_FEATURE_BACKEND_MIL2 = 45
GPUCLOTH_FEATURE_MASS_VERTEX_GROUP = 47
GPUCLOTH_FEATURE_STIFFNESS_VERTEX_GROUPS = 48
...
GPUCLOTH_CACHE_FLAG_EXTERNAL_READ_ONLY = 1 << 0
GPUCLOTH_CACHE_FLAG_LIBRARY_PATH = 1 << 1
...
GPUCLOTH_SOLVER_PD = 1 << 0
GPUCLOTH_SOLVER_MIL2 = 1 << 1
