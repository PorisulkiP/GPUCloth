...
#        for i in mesh_data.vertices:
#            newCoor = i.co
##            newCoor[2] += (bpy.context.scene.gravity[2] / bpy.context.scene.render.fps)/100
#    
#    return gravityCalc

# при первом запуске надо ставить 0, далее перевести в 1
i = 0
if i == 0:
    # Выделяем все объескты в сцене
...
#bpy.app.handlers.frame_change_post.append(physicsCalculation())
